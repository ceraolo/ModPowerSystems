...
annotation (
    Icon(graphics={                                            Ellipse(extent={{50,52},
              {-48,-50}},        lineColor={0,0,255},
          rotation=360,
          fillPattern=FillPattern.Solid,
          fillColor={255,255,255}),                                                             Line(origin = {-66, 0}, points={{-30,0},
              {18,0}},
          color={0,0,255}),                                                                                                                                     Line(origin = {67, 0}, points={{29,0},{
              -17,0}},
          color={0,0,255}),                                                                                                                                                                                           Line(origin = {-0.255164, 70}, points={{
              0.255164,30},{0.255164,-18}},
          color={0,0,255}),                                                                                                                                                                                                        Line(
          origin={0,0},
          points={{-20,0},{20,0}},
          color={0,0,255}),                                                                                                                                                                                                        Line(
          origin={-15,-2},
          rotation=180,
          points={{-3.70892,6.0137},{4.29108,-1.98627},{-3.70892,-9.98627}},
          color={0,0,255}),
        Text(
