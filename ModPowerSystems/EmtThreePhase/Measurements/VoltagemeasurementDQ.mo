...
annotation(
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-38, 8}, extent = {{-16, 30}, {100, -44}}, textString = "Voltage measurement DQ")}, coordinateSystem(initialScale = 0.1)));
end VoltagemeasurementDQ;
