...
equation
    ...
    annotation(
      ...
      Icon(graphics = {Ellipse(origin = {-55, -2}, extent = {{-27, 26}, {27, -26}}, endAngle = 360,
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),                                                            Line(origin = {-15.52, 1.21}, points = {{-12.8536, -1.20711}, {-12.8536, -1.20711}, {15.1464, -1.20711}, {15.1464, -1.20711}}, thickness = 1), Rectangle(origin = {30, -1}, lineThickness = 0.75, extent = {{-30, 15}, {30, -15}},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),                                                                                                                                                                                                        Text(origin={32,-2},    extent = {{-38, 16}, {38, -16}}, textString = "LC"), Line(origin = {79, 0}, points = {{-19, 0}, {19, 0}, {19, 0}}, thickness = 0.75), Line(origin = {-80.8489, -0.170593}, points = {{-19, 0}, {-1, 0}, {-1, 0}}, thickness = 0.75), Rectangle(origin = {54, 56}, lineThickness = 0.5, extent = {{-18, 14}, {12, -8}},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),                                                                                                                                                                                                        Text(origin={57.5,
              56.5},                                                                                                                                                                                                        extent={{-19.5,
              7.5},{10.5,-4.5}},                                                                                                                                                                                                        textString = "PLL"), Rectangle(origin = {-20, 58}, extent = {{-70, 10}, {42, -10}},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid),                                                                                                                                                                                                        Text(origin={-27.9693,
              54.5},                                                                                                                                                                                                        extent={{
              -62.0307,7.5},{49.9693,-2.5}},                                                                                                                                                                                                        textString = "CONTROLLER"), Line(origin = {73, 29}, points = {{7, -29}, {7, 29}, {-7, 29}}, arrow = {Arrow.None, Arrow.Filled}), Line(origin = {29, 58}, points = {{7, 0}, {-7, 0}}, arrow = {Arrow.None, Arrow.Filled}), Line(origin = {-58, 36}, rotation = 180, points = {{0, 12}, {0, -12}, {0, -12}}, thickness = 0.75, arrow = {Arrow.Filled, Arrow.None}), Rectangle(origin = {0, 20}, extent = {{-100, 60}, {100, -60}}), Text(origin = {0, -68}, extent = {{-60, 16}, {60, -16}}, textString = "%name",
          textColor={0,0,255})},                                                                                                                                                                                                        coordinateSystem(initialScale = 0.1)));
end InverterPQCtrl;
