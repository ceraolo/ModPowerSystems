...
equation
     v[1] = sqrt(2)*Vnom/sqrt(3)*cos(system.theta + phiV - phaseShift[1]);
     v[2] = sqrt(2)*Vnom/sqrt(3)*cos(system.theta + phiV - phaseShift[2]);
     v[3] = sqrt(2)*Vnom/sqrt(3)*cos(system.theta + phiV - phaseShift[3]);
