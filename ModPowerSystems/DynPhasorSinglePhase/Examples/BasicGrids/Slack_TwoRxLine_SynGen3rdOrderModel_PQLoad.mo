...
model Slack_TwoRxLine_SynGen3rdOrderModel_PQLoad
  ...
  Loads.PQLoad PQLoad(
    Vnom=24e3,
    Pnom=100e6,
    Qnom=0) annotation (Placement(transformation(extent={{22,-48},{42,-28}})));
...
equation
  ...
  connect(Pm.y, synchronousGenerator_Park.P_m_in) annotation (
    Line(points={{-49.5,-71},{-17.75,-71},{-17.75,-68},{-14.025,-68},{-14.025,
          -72},{-10.3,-72}},                                                                                  color = {0, 0, 127}));
  connect(Pm.y, exciterSteadyState.P) annotation (
    Line(points={{-49.5,-71},{-44.75,-71},{-44.75,-67},{-40,-67},{-40,-85.6},{
          -33,-85.6}},                                                                                  color = {0, 0, 127}));
  connect(Q.y, exciterSteadyState.Q) annotation (
    Line(points={{-49.5,-91},{-41.75,-91},{-41.75,-86.4},{-37.375,-86.4},{
          -37.375,-90.4},{-33,-90.4}},                                                                              color = {0, 0, 127}));
  ...
  connect(N1.Pin1, PQLoad.Pin1)
    annotation (Line(points={{0,-28},{16,-28},{32,-28}}, color={0,0,0}));
  connect(N1.Pin1, L12.Pin1) annotation (Line(points={{0,-28},{0,-28},{0,-34},{
          1.77636e-015,-34}}, color={0,0,0}));
  ...
  annotation (
    ...
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-60, 40}, {40, -100}})),
    experiment(
      StopTime=30,
      Interval=0.001,
      __Dymola_fixedstepsize=1e-005,
      __Dymola_Algorithm="Euler"));
end Slack_TwoRxLine_SynGen3rdOrderModel_PQLoad;
