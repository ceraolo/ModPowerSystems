...
model CIGRE_MV_PQLoad
  ...
  inner ModPowerSystems.Base.System system
    annotation (Placement(transformation(origin = {160, -92}, extent = {{-160, 220}, {-120, 260}})));
equation
  connect(slack.Pin1,N0.Pin1)
   annotation(Line(points={{34,204},{34,196}},      color = {0, 0, 0}, smooth = Smooth.None));
  connect(Tr1.Pin1,N0.Pin1)
   annotation(Line(points={{-74,176},{-74,192},{34,192},{34,196}},                               color = {0, 0, 0}, smooth = Smooth.None));
  connect(Tr1.Pin2,N1.Pin1)
   annotation(Line(points={{-74,156},{-74,146}},      color = {0, 0, 0}, smooth = Smooth.None));
  connect(Tr2.Pin1,N0.Pin1)
   annotation(Line(points={{106,176},{106,192},{34,192},{34,196}},                             color = {0, 0, 0}, smooth = Smooth.None));
  connect(Tr2.Pin2,N12.Pin1)
   annotation(Line(points={{106,156},{106,146}},    color = {0, 0, 0}, smooth = Smooth.None));
  ...
  connect(L12_13.Pin2,N13.Pin1)
   annotation(Line(points={{106,112},{106,104}},  color = {0, 0, 0}, smooth = Smooth.None));
  ...
  connect(L12_13.Pin1,N12.Pin1)
   annotation(Line(points={{106,132},{106,146}},    color = {0, 0, 0}, smooth = Smooth.None));
