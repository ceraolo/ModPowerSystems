...
model IEEE_9Bus_PQLoad
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_B_05_06(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003226, x = 0.020851) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_D_07_08(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003226, x = 0.069502) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_E_07_08(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003226, x = 0.069502) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_F_08_09(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003226, x = 0.069502) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_A05_07(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003618, x = 0.024241) annotation (
    Placement(visible = true, transformation(origin = {-8, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_C06_07(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003618, x = 0.024241) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Generation.PVNode GEN1(Pgen = 41e9, Vabs = 1.03, Vnom = 10000) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Generation.PVNode GEN2(Pgen = 1200e6, Vabs = 1.05, Vnom = 10e3) annotation (
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine LINE_G_08_09(Vnom = 10e3,b = 0, g = 0, length = 1, r = 0.003226, x = 0.069502) annotation (
    Placement(visible = true, transformation(origin = {115, 30}, extent = {{-9, -8}, {9, 8}}, rotation = 0)));
  ModPowerSystems.PhasorSinglePhase.Generation.PVNode GEN3(Pgen = 3780.1e6, Vabs = 1.032, Vnom = 10e3) annotation (
