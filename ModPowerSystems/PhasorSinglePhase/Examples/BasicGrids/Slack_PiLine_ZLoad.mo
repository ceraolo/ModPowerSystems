...
inner ModPowerSystems.Base.System system
  ...
  ModPowerSystems.PhasorSinglePhase.Connections.PiLine piLine(Vnom = 110e3, b = 40e-6, g = 0,length = 20, r = 0.207, x = 0.121)
   annotation (
...
equation
  ...
  connect(N0.Pin1, piLine.Pin1)
   annotation(
    Line(points = {{0, 0}, {0, 0}, {0, -4}}, color = {0, 0, 0}));
  connect(N1.Pin1, piLine.Pin2)
   annotation(
